var P=n=>{throw TypeError(n)};var L=(n,l,r)=>l.has(n)||P("Cannot "+r);var g=(n,l,r)=>(L(n,l,"read from private field"),r?r.call(n):l.get(n)),h=(n,l,r)=>l.has(n)?P("Cannot add the same private member more than once"):l instanceof WeakSet?l.add(n):l.set(n,r),f=(n,l,r,a)=>(L(n,l,"write to private field"),a?a.call(n,r):l.set(n,r),r);import{H as S,S as k}from"./assets/vendor-Bi_J8_6n.js";(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const e of t)if(e.type==="childList")for(const s of e.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function r(t){const e={};return t.integrity&&(e.integrity=t.integrity),t.referrerPolicy&&(e.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?e.credentials="include":t.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function a(t){if(t.ep)return;t.ep=!0;const e=r(t);fetch(t.href,e)}})();function b(){return{searchForm:document.querySelector(".js-search-form"),imageGallery:document.querySelector(".js-gallery"),loader:document.querySelector(".js-loader")}}const q="43520057-d4110ce2722b475a1deefaa82",O="https://pixabay.com/api/";var y,u;class I{constructor(){h(this,y);h(this,u);f(this,y,""),f(this,u,1)}get query(){return g(this,y)}set query(l){f(this,y,l)}get page(){return g(this,u)}set page(l){f(this,u,l)}incrementPage(){f(this,u,g(this,u)+1)}resetPage(){f(this,u,1)}fetchImages(){const l=new URLSearchParams({key:q,q:g(this,y),page:g(this,u),per_page:10,image_type:"photo",orientation:"horizontal",safesearch:!0}),r=`${O}?${l}`;return fetch(r).then(a=>{if(!a.ok)throw new Error(`HTTP error: ${a.status}`);return a.json()}).then(a=>(this.incrementPage(),a))}}y=new WeakMap,u=new WeakMap;const R=S.template({1:function(n,l,r,a,t){var e,s=l??(n.nullContext||{}),i=n.hooks.helperMissing,c="function",m=n.escapeExpression,o=n.lookupProperty||function(d,w){if(Object.prototype.hasOwnProperty.call(d,w))return d[w]};return`  <li class='gallery-item'>
    <article>
