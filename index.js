    ...
    <article class='card'>
      ...
      <div class='card-content'>
        <ul class='card-socials'>
          <li>
            <h3>likes</h3>
            <p>`+h((e=(e=r(l,"likes")||(n!=null?r(n,"likes"):n))!=null?e:i,typeof e===c?e.call(o,{name:"likes",hash:{},data:s,loc:{start:{line:19,column:15},end:{line:19,column:24}}}):e))+`</p>
          </li>
          <li>
            <h3>views</h3>
            <p>`+h((e=(e=r(l,"views")||(n!=null?r(n,"views"):n))!=null?e:i,typeof e===c?e.call(o,{name:"views",hash:{},data:s,loc:{start:{line:23,column:15},end:{line:23,column:24}}}):e))+`</p>
          </li>
          <li>
            <h3>comments</h3>
            <p>`+h((e=(e=r(l,"comments")||(n!=null?r(n,"comments"):n))!=null?e:i,typeof e===c?e.call(o,{name:"comments",hash:{},data:s,loc:{start:{line:27,column:15},end:{line:27,column:27}}}):e))+`</p>
          </li>
          <li>
            <h3>downloads</h3>
            <p>`+h((e=(e=r(l,"downloads")||(n!=null?r(n,"downloads"):n))!=null?e:i,typeof e===c?e.call(o,{name:"downloads",hash:{},data:s,loc:{start:{line:31,column:15},end:{line:31,column:28}}}):e))+`</p>
          </li>
        </ul>
      </div>
    </article>
  </li>
`},compiler:[8,">= 4.3.0"],main:function(t,n,l,a,s){var e,o=t.lookupProperty||function(i,c){if(Object.prototype.hasOwnProperty.call(i,c))return i[c]};return(e=o(l,"each").call(n??(t.nullContext||{}),n,{name:"each",hash:{},fn:t.program(1,s,0),inverse:t.noop,data:s,loc:{start:{line:1,column:0},end:{line:37,column:9}}}))!=null?e:""},useData:!0}),R=M();function Q(t){R.galleryContainer.insertAdjacentHTML("beforeend",D(t))}function z(){R.galleryContainer.innerHTML=""}const x=M(),m=new C,A=new I,L=new O({selector:".js-gallery-search-btn",enabledLabel:"Знайти",disabledLabel:"Пошук"}),y=new O({selector:".js-load-more-btn",enabledLabel:"Показати ще",disabledLabel:"Завантаження",hidden:!0});L.enable();x.searchForm.addEventListener("submit",F);x.loadMoreBtn.addEventListener("click",H);function F(t){t.preventDefault();const n=t.currentTarget;if(m.searchQuery=n.elements.query.value,!m.searchQuery){b.showWarningMsg(b.MESSAGES.BAD_REQUEST);return}N(),q().then(()=>{A.initialize(),L.enable()}).catch(l=>{console.log(l)}),n.reset()}function H(){q().then(()=>{A.refresh()})}function q(){return y.disable(),m.fetchImages().then(t=>{if(m.searchQuery&&!t.length){b.showErrorMsg(b.MESSAGES.NOT_FOUND);return}Q(t)}).then(()=>{if(m.searchQuery&&m.isLastPage){y.hide();return}y.show(),y.enable()}).catch(t=>{console.log(t)})}function N(){m.resetPage(),m.isLastPage=!1,L.disable(),y.hide(),z()}
